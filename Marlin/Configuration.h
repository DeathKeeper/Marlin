...
#define STRING_CONFIG_H_AUTHOR "(Yos, Atom_Style)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Atom_Style"
...
// Atom_Style
  #define DEFAULT_Kp 14.50// P14.50 I1.10 D38.37
  #define DEFAULT_Ki 1.10
  #define DEFAULT_Kd 38.37
...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 12.0     // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 238.76        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 265.5             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 112.6              // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 50.45*8 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 500, 35 }
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 5000, 5000, 5000, 20000 } // ...or, set your own edit limits
#endif
...
#define CLASSIC_JERK
  ...
  //#define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 20, 20, 10, 10 } // ...or, set your own edit limits
  #endif
#endif
 ...
 *
 */
#define Z_MIN_PROBE_PIN P0_10 // Pin 32 is the RAMPS default//Yos - maybe need changing
